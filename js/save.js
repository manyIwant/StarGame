...
// ===== 星际探索存档 =====
function savePlayer(){try{var d={shipName:S.shipName,energy:S.energy,minerals:S.minerals,dataCrystals:S.dataCrystals,reputation:S.reputation,shipLevel:S.shipLevel,currentLocation:S.currentLocation,currentPlanet:S.currentPlanet,exploredPlanets:S.exploredPlanets};localStorage.setItem('gdstar_player',JSON.stringify(d));}catch(e){}}
function loadPlayer(){try{var d=localStorage.getItem('gdstar_player');if(d){var p=JSON.parse(d);S.shipName=p.shipName||'探索者号';S.energy=p.energy!=null?p.energy:100;S.minerals=p.minerals!=null?p.minerals:50;S.dataCrystals=p.dataCrystals!=null?p.dataCrystals:0;S.reputation=p.reputation!=null?p.reputation:0;S.shipLevel=p.shipLevel||1;S.currentLocation=p.currentLocation||'太阳系';S.currentPlanet=p.currentPlanet||null;S.exploredPlanets=p.exploredPlanets||[];if(S.currentPlanet&&S.currentPlanet.explored){S.currentPlanet=null;S.currentLocation='深空';}}}catch(e){}}
